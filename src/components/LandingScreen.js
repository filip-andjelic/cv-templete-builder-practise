...
export default class LandingScreen extends React.Component {
    ...
    render() {
        return (
            <div
                id="landing-screen"
                className="column white-text grow-1 padding-30"
            ...
            >
                <div className="column center grow-1">
                    <h1 className="text-shadow-1 text-center uppercase gigant-text">
                        {this.props.data && this.props.data.mainHeader
                            ? this.props.data.mainHeader + "!"
                            : "Welcome!"}
                    </h1>
                    <h3 className="text-shadow-1 text-center large-text">
                        {this.props.data && this.props.data.subHeader
